...
<body onload="info_noti()">
	<!--wrapper-->
	<div class="wrapper toggled" id="sidebar">
		<!--sidebar wrapper -->
			...
			<ul class="metismenu" id="menu">
				<li>
					<a href="javascript:;" class="has-arrow/">
						...
						<div class="menu-title">Acceuil</div>
					</a>
					<!-- <ul>
	...
	<div class="switcher-wrapper">
		...
		<div class="switcher-body">
			...
			<div class="d-flex align-items-center justify-content-between">
				<div class="form-check" data-value="preso" data-couleur="light-theme">
					<input class="form-check-input" type="radio" name="theme" id="lightmode" checked>
					<label class="form-check-label" for="lightmode">Light</label>
				</div>
				<div class="form-check" data-value="preso" data-couleur="dark-theme">
					<input class="form-check-input" type="radio" name="theme" id="darkmode">
					<label class="form-check-label" for="darkmode">Dark</label>
				</div>
				<div class="form-check" data-value="preso" data-couleur="semi-dark">
					<input class="form-check-input" type="radio" name="theme" id="semidark">
					<label class="form-check-label" for="semidark">Semi Dark</label>
				</div>
			</div>
			<hr/>
			<div class="form-check" data-value="preso" data-couleur="minimal-theme">
				<input class="form-check-input" type="radio" id="minimaltheme" name="theme">
	...
	<!-- parametre js -->
	<script src="assets/js/parametre.js"></script>
